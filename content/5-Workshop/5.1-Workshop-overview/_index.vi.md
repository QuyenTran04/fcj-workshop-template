...
<img src="/fcj-template/images/5-Workshop/5.1-Workshop-overview/trustbite-aws-architecture.png" alt="Sơ đồ kiến trúc triển khai TrustBite trên AWS" style="width: 100%; max-width: 1200px; display: block; margin: 1.5rem auto; border-radius: 6px; box-shadow: 0 4px 20px rgba(0,0,0,0.08);" />
